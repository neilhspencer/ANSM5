...
#' 
#' @description
#' `shapirotest.ANSM()` is a wrapper for stats::shapiro.test - performs the Shapiro-Wilk test of Normality and is used in chapters 4 and 5 of `Applied Nonparametric Statistical Methods` (5th edition)
#' 
