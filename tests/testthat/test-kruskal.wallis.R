test_that("Example 7.1", {
  expect_equal(kruskal.wallis(ch7data$affordability,
                              ch7data$regions)$pval.exact.stat, 6.7454545)
  expect_equal(kruskal.wallis(ch7data$affordability,
                              ch7data$regions)$pval.exact, 0.01)
  expect_equal(
    kruskal.wallis(ch7data$affordability, ch7data$regions, do.exact = FALSE,
...
test_that("Example 7.2", {
  expect_equal(kruskal.wallis(ch7data$age, ch7data$positions)$pval.exact.stat,
               2.734127)
  expect_equal(kruskal.wallis(ch7data$age, ch7data$positions)$pval.exact,
               0.270820846)
  expect_equal(kruskal.wallis(ch7data$age, ch7data$positions, do.exact = FALSE,
...
test_that("Exercise 7.2", {
  expect_equal(kruskal.wallis(ch7data$sentences, ch7data$author,
...
test_that("Exercise 7.4", {
  expect_equal(kruskal.wallis(ch7data$head.width, ch7data$species,
