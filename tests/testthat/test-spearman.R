test_that("Example 10.2", {
  ...
  expect_equal(spearman(ch10$q1, ch10$q2, alternative = "greater",
               ...
               0.079552885)
  tmp <- spearman(ch10$q1, ch10$q2, alternative = "greater", seed = 1)
  expect_equal(tmp$stat, 0.43356643)
  expect_equal(tmp$pval.mc, 0.08155)
})
...
test_that("Example 10.4", {
  tmp <- spearman(ch10$death.year, ch10$age.at.death, alternative = "greater",
                  seed = 1)
  expect_equal(tmp$stat, 0.50688898)
  expect_equal(tmp$pval.mc, 0.0399)
})
